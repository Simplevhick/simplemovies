  ...
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-4">
      ...
      <p>
        ...
        moives from all around the world, along with the latest news, reviews,
      ...
      <p>
        ...
        for movie lovers to connect and share their thought on latest releases.
        Our community section includes a forum where you can discuss your
        favourite films with like-minded individuals and read reviews and
        ...
        the world of cinema. Thank you for visiting our website and we hope you
        enjoy your time browsing through our movie database. If you have any
        feedbacks or suggestions, please feel free to contact us. We are always
